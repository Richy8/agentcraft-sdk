...
| `sharedAdapters`, `sharedSkills`                    | No                 | Shared capabilities                          | Avoids duplicating common tools/skills across members.              | [Skill composition](../../examples.md#skill-composition) |
